 /* ===== i18n ===== */
  const translations = {
    ...
    navGuideControl:{fa:'آموزش کنترل پنل', en:'Control Panel Guide'},
    ...
    gControlT:{fa:'آموزش کنترل پنل', en:'Control Panel Guide'},
    gControlSub:{fa:'آموزش ری‌استارت، خاموش کردن پنل مدیریت و قطع سرویس‌ها', en:'Restart, turn off admin panel, and service stop guide'},
    gControlPart1T:{fa:'ری‌استارت پنل', en:'Restart Panel'},
    gControlPart1D:{fa:'شمارشگر آپتایم و کش‌های موقت داخلی ورکر پاک‌سازی می‌شود. کاربران و تنظیمات شما دست‌نخورده باقی می‌مانند.', en:'Uptime counters and internal temporary worker caches are cleared. Your users and settings remain untouched.'},
    gControlPart2T:{fa:'خاموش کردن پنل مدیریت', en:'Turn Off Admin Panel'},
    gControlPart2D:{fa:'با فعال شدن این گزینه، صفحه ورود و پنل مدیریت برای همه غیرقابل دسترسی می‌شود و صفحه وضعیت Nexa نمایش داده می‌شود. سرویس‌های VPN فعال باقی می‌مانند. برای بازگشت، آدرس را با ?unlock=1 باز کنید (مثال: /admin?unlock=1).', en:'When enabled, the login page and admin panel become inaccessible to everyone and the Nexa status page is shown. VPN services remain active. To restore access, open the address with ?unlock=1 (e.g., /admin?unlock=1).'},
    gControlPart3T:{fa:'قطع تمامی سرویس‌ها', en:'Stop All Services'},
    gControlPart3D:{fa:'با روشن شدن این گزینه تمامی سرویس‌ها متوقف و قطع خواهند شد در صورتی که مورد سو استفاده قرار گرفتید این گزینه را روشن کنید و با عوض کردن آدرس ها پنل خود را امن کنید .', en:'Turning on this option will stop and cut off all services. If you suspect any abuse, turn on this option and secure your panel by changing the access paths.'},
